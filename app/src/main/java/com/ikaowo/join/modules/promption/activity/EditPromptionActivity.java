  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    networkManager.async(this, Constant.DATAGETTING, call,
        new KwMarketNetworkCallback<PromptionResponse>(this) {
          @Override public void onSuccess(PromptionResponse response) {
            ...
            if (!TextUtils.isEmpty(notificationType) && notificationType.equalsIgnoreCase(
                Constant.PUSH_PROMPTION_FAILED)) {

              if (!promption.state.equalsIgnoreCase(Constant.PROMPTION_STATE_FAILED)) {
                new JDialogHelper(EditPromptionActivity.this).showConfirmDialog(
                    R.string.hint_state_update, R.string.custom_ok_btn,
