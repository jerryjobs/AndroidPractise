...
public class JoinDetailActivity extends BaseActivity {
  ...
  @Bind(R.id.tumblrs_layout) LinearLayout tumblrsLayout;
  @Bind(R.id.avatar_layout) FrameLayout avatarLayout;
  @Bind(R.id.brand_logo) ImageView brandLogo;
    ...
    JApplication.getNetworkManager()
        .async(this, Constant.DATAGETTING, call,
            new KwMarketNetworkCallback<JoinInfoResponse>(this) {
              @Override public void onSuccess(JoinInfoResponse joinInfoResponse) {
                ...
                AvatarHelper.getInstance()
                    .showAvatar(JoinDetailActivity.this, joinInfo.userId, iconIv, shortNameTv,
                        userIconTargetWidth, userIconTargetHeight, joinInfo.userIcon,
                        joinInfo.nickname);

                nameTitleTv.setText(
                    getString(R.string.user_name_and_title, joinInfo.nickname, joinInfo.title));
  ...
  @OnClick(R.id.chat) public void chat() {
    userService.imChat(this, wxId);
  }

  @OnClick(R.id.call) public void call() {
    Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel://" + phone));
    startActivity(intent);
  }

  @OnClick(R.id.brand_layout) public void viewBrand() {
    brandService.viewBrandDetail(this, brandId);
  }

  @OnClick(R.id.rejectBtn) public void reject() {
    sendRequest(Constant.JOIN_STATE_FAILED);
  }

  @OnClick(R.id.approveBtn) public void approve() {
