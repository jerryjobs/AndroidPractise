...
public class UserServiceImpl extends UserService {
  ...
  @Override public void doAfterSignin(Context context, SignupResponse signupResponse) {
  ...
  @Override public void interceptorCheckUserState(final Context context, int actionRes,
      final AuthedAction authedAction) {
    if (isAuthed()) {
  ...
  private void checkState(final Context context, final int actionRes,
      final AuthedAction authedAction) {
    ...
    checkLatestUserState(context, new CheckStateCallback() {
      @Override public void onProcessing() {
        if (context instanceof JoinActivity) {
          new JDialogHelper(context).showConfirmDialog(
              context.getString(R.string.unauthed_hint, actionStr),
              context.getString(R.string.custom_ok_btn), new JDialogHelper.DoAfterClickCallback() {
      ...
      @Override public void onFailed() {
        ...
        if (context instanceof JoinActivity) {
          dialog = new JDialogHelper((JFragmentActivity) context).createDialog(context,
              context.getString(R.string.dialog_title),
              context.getString(R.string.auth_failed_hint, actionStr),
              new String[] { "我知道了", "重新审核" }, new View.OnClickListener[] {
