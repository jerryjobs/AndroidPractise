...
public class MineFragment extends BaseFragment implements EventBusListener {
  ...
  @Bind(R.id.promption) RelativeLayout promptionLayout;

  @Bind(R.id.brand_info) RelativeLayout companyLayout;

  @Bind(R.id.abount) RelativeLayout aboutLayout;
  ...
  private void setupData() {
    if (userService.isLogined()) {
      ...
      AvatarHelper.getInstance()
          .showAvatar(getContext(), user.uId, iconIv, shortNameTv, targetImgWidth, targetImgHeight,
              user.icon, user.nickName);
      nameTitleTv.setText(
          getContext().getString(R.string.user_name_and_title, user.nickName, user.title));
