...
public class SystemNotificationActivity
  ...
  @Override protected void performCustomItemClick(final Notification notification) {
    ...
    processer.action(this, notification.id, notification.isRead,
        String.valueOf(notification.targetId), notification.url);
  ...
  class NotificationAdapter extends JAdapter<Notification> {
    ...
    @Override public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
      if (holder instanceof NotificationViewHolder) {
        ...
        if (notification.isRead) {
          viewHolder.timeTv.setTextColor(
              ContextCompat.getColor(SystemNotificationActivity.this, R.color.c9));
          viewHolder.titleTv.setTextColor(
              ContextCompat.getColor(SystemNotificationActivity.this, R.color.c9));
          viewHolder.contentTv.setTextColor(
              ContextCompat.getColor(SystemNotificationActivity.this, R.color.c9));
        } else {
          viewHolder.timeTv.setTextColor(
              ContextCompat.getColor(SystemNotificationActivity.this, R.color.c9));
          viewHolder.titleTv.setTextColor(
              ContextCompat.getColor(SystemNotificationActivity.this, R.color.c3));
          viewHolder.contentTv.setTextColor(
              ContextCompat.getColor(SystemNotificationActivity.this, R.color.c10));
        }
      }
