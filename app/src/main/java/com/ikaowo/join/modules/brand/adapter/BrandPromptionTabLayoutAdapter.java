...
public class BrandPromptionTabLayoutAdapter extends TabLayoutAdapter {
  ...
  @Override protected void initFragments(int brandId) {
    ...
    BrandJoinedPromptionListFragment brandJoinedPromptionListFragment =
        new BrandJoinedPromptionListFragment();
    brandJoinedPromptionListFragment.setArguments(companyIdBundle);
    BrandPostedPromptionListFragment postedPromptionListFragment =
        new BrandPostedPromptionListFragment();
