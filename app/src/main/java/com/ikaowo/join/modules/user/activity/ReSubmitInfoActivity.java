...
public class ReSubmitInfoActivity extends BaseUserInputActivity {
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    boolean fromPush = getIntent().getExtras() == null ? false
        : getIntent().getExtras().getBoolean(Constant.NEED_RETRIEVE_LATEST_STATE, false);
            ...
            @Override public void onSuccess(final CheckStateResponse stateResponse) {
              if (stateResponse != null && stateResponse.data != null) {
                ...
                if (!user.state.equalsIgnoreCase(Constant.AUTH_STATE_FAILED)) {
                  new JDialogHelper(ReSubmitInfoActivity.this).showConfirmDialog(
