...
public interface PromptionInterface {
    ...
    Call<PromptionResponse> getPromption(
            @Path("promption_id") int promptionId);

    @GET("social/info")
    Call<BaseListResponse<Promption>> getBrandPostedPromptionList(@QueryMap Map map);
    ...
    //我发布的活动列表
    @GET("social/myinfo")
    Call<BaseListResponse<Promption>> getUserPostedPromptionList(@QueryMap Map map);

    //我参加过的活动列表
    @GET("social/myDetailinfo")
    Call<BaseListResponse<Promption>> getUserJoinedPromptionList(@QueryMap Map map);
    ...
    Call<BaseListResponse<JoinedUser>> getApprovedList(
            @QueryMap Map map);

    @PUT("social/complete")
    Call<BaseResponse> completePromption(
            @Body CompletePromptionRequest request);

    @PUT("social/state")
    Call<BaseResponse> updatePromptionState(
