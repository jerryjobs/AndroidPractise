...
public class MainActivity extends BaseActivity {
  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    shareBtn.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        umengShareService.openShareWindow(MainActivity.this, toolbar, "test", "test",
    ...
    netAsync.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        ...
        call.enqueue(new Callback<UserInfoResponse>() {
          @Override public void onResponse(Response<UserInfoResponse> response, Retrofit retrofit) {
    ...
    loginBtn.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        ...
        call.enqueue(new KwMarketNetworkCallback<LoginResponse>(MainActivity.this) {
          ...
          @Override public void onSuccess(LoginResponse loginResponse) {
    ...
    showDialogBtn.setOnClickListener(new View.OnClickListener() {
      @Override public void onClick(View v) {
        dialog = dialogHelper.createDialog(MainActivity.this, "信息",
            "对了上次有邻居说了解怎么去政府抗议，我觉得这个事情也可以计划起来了，" + "总觉得周六去了也没法马上起到很好的效果，多半得几条路一起走",
