...
public class VerifyCodeHelper {
  ...
  public VerifyCodeHelper(final Context context, final EditText phoneEt, final TextView getVerifyBtn) {
    ...
    this.countDownTimer = new CountDownTimer(60 * 1000, 1 * 1000) {
      ...
      public void onTick(long millisUntilFinished) {
        String text = context.getString(R.string.verify_code_time_remaining, millisUntilFinished / 1000);
