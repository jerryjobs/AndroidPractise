...
public abstract class UserService extends JCommonService {
  ...
  public abstract void interceptorCheckUserState(Context context, int actionStr, AuthedAction authedAction);
  ...
  public abstract void reSubmitInfo(Context context, boolean needCheckState);
