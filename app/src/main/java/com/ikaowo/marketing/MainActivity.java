...
import com.ikaowo.marketing.network.bean.response.LoginResponse;
import com.ikaowo.marketing.network.bean.response.UserInfoResponse;
...
public class MainActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        showDialogBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = dialogHelper.createDialog(MainActivity.this, "信息", "对了上次有邻居说了解怎么去政府抗议，我觉得这个事情也可以计划起来了，总觉得周六去了也没法马上起到很好的效果，多半得几条路一起走",
