...
public class JDialogHelper {
  ...
  public void showConfirmDialog(final String msg, final DoAfterClickCallback callback) {
    String okBtnStr = "确定";
    showConfirmDialog(msg, okBtnStr, callback);
  }

  public void showConfirmDialog(final int msgRes, final DoAfterClickCallback callback) {
    String msg = context.getString(msgRes);
  ...
  public Dialog createDialog(int contentRes, String[] buttons, View.OnClickListener[] listeners) {
    String title = "提示";
    String content = context.getString(contentRes);
    return createDialog(context, title, content, buttons, listeners);
  }

  public Dialog createDialog(int titleRes, int contentRes, String[] buttons,
