...
public class JServiceManagerImpl implements JServiceManager {
  ...
  @Override public boolean registerService(JServiceInfo serviceInfo) {
  ...
  @Override public <T> T getServiceByInterface(Class<? extends JCommonService> serviceInterface) {
